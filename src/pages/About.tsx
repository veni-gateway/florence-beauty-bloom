...
const timeline = [
  ...
  {
    year: "2023",
    t: "The Bridal Atelier opens",
    d: "We were called for our first wedding morning. We never stopped showing up.",
  },
  {
    year: "2026",
    t: "A new home",
    d: "We moved to our flagship — pink walls, gold mirrors, a softer kind of luxury.",
  },
];

const team = [
  {
    name: "Shobhana Parmar",
    role: "Founder & Beauty Director",
    image: director,
    grad: "linear-gradient(135deg, hsl(350 70% 88%), hsl(38 60% 88%))",
  },
  {
    name: "Falguni Parmar",
    role: "Co Founder & Nail Technician",
    image: codirector,
    grad: "linear-gradient(135deg, hsl(270 50% 90%), hsl(350 70% 90%))",
  },
];
  ...
  <main className="min-h-screen bg-background">
      ...
      <div className="container relative text-center max-w-3xl space-y-6">
        ...
        <Reveal delay={0.1}>
          <h1 className="font-serif text-[clamp(2.8rem,7vw,6rem)] leading-[1.02]">
            A studio built on{" "}
            <em className="text-gradient-gold not-italic">soft hands</em> and
            softer mornings.
          </h1>
        </Reveal>
        <Reveal delay={0.2}>
        ...
        <Reveal delay={0.15}>
          <div className="space-y-6">
            ...
            <h2 className="font-serif text-5xl md:text-6xl leading-tight">
              "I wanted a place where women could just{" "}
              <em className="text-gradient-gold not-italic">exhale</em>."
            </h2>
            <p className="text-muted-foreground text-lg leading-relaxed">
              I grew up watching my mother get ready for weddings — the rush,
              the borrowed lipsticks, the quiet hope that today she'd feel
              beautiful. Florence is the studio I wish she'd had. A slow
              morning. A warm mirror. Someone who saw her.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              Every chair in our studio is built on that promise. You'll never
              be rushed. You'll never be a number. You'll always be the bride of
              your own life.
            </p>
            <p className="font-serif text-2xl pt-2">— Shobhana Parmar</p>
          </div>
        </Reveal>
      </div>
    </section>
    ...
    <section className="py-24 bg-gradient-soft">
      <div className="container max-w-5xl">
        <Reveal>
          <p className="text-xs tracking-[0.4em] uppercase text-gold text-center mb-3">
            Our Philosophy
          </p>
        </Reveal>
        <Reveal delay={0.1}>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            {
              t: "Slow beauty",
              d: "No rushed appointments. Ever. Beauty needs breath.",
            },
            {
              t: "Honest mirrors",
              d: "We tell you what suits you, even when it isn't what's trending.",
            },
            {
              t: "Soft luxury",
              d: "Premium products, gentle hands, an atmosphere that exhales.",
            },
          ].map((p, i) => (
    ...
    <section className="py-28">
      <div className="container max-w-4xl">
        ...
        <Reveal delay={0.1}>
          <h2 className="font-serif text-5xl md:text-6xl text-center mb-16">
            A soft little timeline.
          </h2>
        </Reveal>
            ...
            {timeline.map((item, i) => (
              <Reveal key={item.year} delay={i * 0.1}>
                ...
                >
                  ...
                  >
                    <p className="font-serif text-5xl text-gradient-gold mb-2">
                      {item.year}
                    </p>
          ...
          {team.map((m, i) => (
            <Reveal key={m.name} delay={i * 0.08}>
              <motion.div
                ...
                className="group"
              >
                <div className="relative aspect-[3/4] rounded-3xl overflow-hidden shadow-soft group-hover:shadow-petal transition-shadow duration-700">
                  {m.image ? (
                    <img
                      src={m.image}
                      alt={m.name}
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-5 translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                    <div className="inline-block rounded-2xl bg-white/13 backdrop-blur-md px-4 py-3">
    ...
    <section className="py-24">
      <div className="container text-center space-y-6">
        ...
        <Reveal delay={0.1}>
          <Link
            to="/contact"
            className="inline-flex rounded-full bg-gradient-gold px-8 py-4 text-gold-foreground shadow-gold hover:-translate-y-0.5 transition-all duration-500"
          >
            Book your visit
          </Link>
        </Reveal>
